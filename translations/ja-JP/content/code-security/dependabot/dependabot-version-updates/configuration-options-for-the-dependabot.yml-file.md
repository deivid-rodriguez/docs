...
| `increase`| `bundler`, `composer`, `npm`, `pip` | Always increase the version requirement to match the new version. |
| `increase-if-necessary` | `bundler`, `composer`, `npm`, `pip` | Increase the version requirement only when required by the new version. |
